/*
  Given the following definition of a Node, please preoder traversal right inside Node. the sequenece 
  returned should be the sequence of values, not their containing nodes.
*/
