...
pf.filterByColor(products, Color.GREEN).forEach((p, index) => console.log(`${index + 1}: ${p.name}`));
...
bf.filter(products, greenSpec).forEach((p, index) => console.log(`${index + 1}: ${p.name}`));

console.log('✅ Large and green Products (new)');
bf.filter(products, largeAndGreenSpec).forEach((p, index) => console.log(`${index + 1}: ${p.name}`));

console.log('✅ Large or blue Products (new)');
bf.filter(products, largeOrBlueSpec).forEach((p, index) => console.log(`${index + 1}: ${p.name}`));